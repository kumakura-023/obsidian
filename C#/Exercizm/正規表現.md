...
{
    // 不正文字があったら例外
    if (Regex.IsMatch(sequence, "[^ATGC]"))
    {
...
public static class Bob
{
    ...
    {
        bool upper = Regex.IsMatch(statement, "[A-Z]");
        bool lower = Regex.IsMatch(statement, "[a-z]");
        bool question = statement.TrimEnd().EndsWith("?");
        if(upper&&!lower)
        {
            if(question) return "Calm down, I know what I'm doing!";
